    ...
    return (
        <>
            <h1>
                ...
                <abbr title="An enthusiast">Aficionados</abbr>!
            </h1>
            <div className="benefits-list">
                <h3 className="font-bolder">
                    Try <span className="text-gradient">CaffeineTrackr</span>{" "}
                    and start ...{" "}
                </h3>
                <p>✅ Tracking every coffee</p>
                <p>✅ Measuring your blood caffeine levels</p>
                <p>✅ Costing and quantifying your coffee drinking</p>
            </div>
            <div className="card info-card">
                ...
                <p>
                    ...
                    Rem odio, mollitia similique eum harum nulla temporibus,
                    accusantium explicabo blanditiis ut laudantium facere
                    reiciendis, atque officia culpa excepturi voluptatum magni
                    perspiciatis.
                </p>
